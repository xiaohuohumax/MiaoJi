    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        createVNode(unref(NSpace), null, {
          default: withCtx(() => [
            createBaseVNode("a", {
              href: unref(appConfig).repository,
              target: "_blank",
