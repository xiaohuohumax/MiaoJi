import{bQ as re,b9 as ne,O as te,z as s,v as p,_ as ie,y as b,x as l,Z as ae,a9 as se,e as _,C as k,B as y,D as de,d as x,F as w,k as f,bR as ce,H as S,a0 as le,bS as be,X as fe,m as ge}from"./index-CxY8spwR.js";import{g as ue}from"./Space-mIpbSOwT.js";function R(e,...o){if(Array.isArray(e))e.forEach(n=>R(n,...o));else return e(...o)}function me(e){return Object.keys(e)}function g(e){return e.some(o=>re(o)?!(o.type===ne||o.type===te&&!g(o.children)):!0)?e:null}function $e(e,o){return e&&g(e())||o()}function _e(e,o,n){return e&&g(e(o))||n(o)}function v(e,o){const n=e&&g(e());return o(n||null)}function ke(e){return!(e&&g(e()))}const he=/^(\d|\.)+$/,$=/(\d|\.)+/;function ve(e,{c:o=1,offset:n=0,attachPx:r=!0}={}){if(typeof e=="number"){const i=(e+n)*o;return i===0?"0":`${i}px`}else if(typeof e=="string")if(he.test(e)){const i=(Number(e)+n)*o;return r?i===0?"0":`${i}px`:`${i}`}else{const i=$.exec(e);return i?e.replace($,String((Number(i[0])+n)*o)):e}return e}function we(e){return e.replace(/#|\(|\)|,|\s|\./g,"_")}const pe=s([p("card",`
