import{i as ie,p as Re,d as z,b as ae,P as se,v as j,e as Y,J as Ie,t as Fe,r as R,n as _e,k as m,z as v,aL as He,aM as le,y as x,x as u,A as oe,I as Ee,B as de,u as Oe,C as je,aN as De,D as Ne,H as r,aO as E,F as Ve,ae as Ke,K as Me,G as Ge,ai as ce,aj as ue,ak as Ae,l as We,m as qe,aP as Le}from"./index-D0bB0mJU.js";import{i as D}from"./Space-DUG0ZluM.js";import{h as re,r as te,i as Qe,c as Ye}from"./_plugin-vue_export-helper-Bn8exm5W.js";const ne=se("n-form-item");function Je(e,{defaultSize:d="medium",mergedSize:f,mergedDisabled:c}={}){const n=ie(ne,null);Re(ne,null);const N=z(f?()=>f(n):()=>{const{size:p}=e;if(p)return p;if(n){const{mergedSize:I}=n;if(I.value!==void 0)return I.value}return d}),P=z(c?()=>c(n):()=>{const{disabled:p}=e;return p!==void 0?p:n?n.disabled.value:!1}),k=z(()=>{const{status:p}=e;return p||(n==null?void 0:n.mergedValidationStatus.value)});return ae(()=>{n&&n.restoreValidation()}),{mergedSizeRef:N,mergedDisabledRef:P,mergedStatusRef:k,nTriggerFormBlur(){n&&n.handleContentBlur()},nTriggerFormChange(){n&&n.handleContentChange()},nTriggerFormFocus(){n&&n.handleContentFocus()},nTriggerFormInput(){n&&n.handleContentInput()}}}const Ue=j("base-wave",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
...
`),Xe=Y({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(e){Ie("-base-wave",Ue,Fe(e,"clsPrefix"));const d=R(null),f=R(!1);let c=null;return ae(()=>{c!==null&&window.clearTimeout(c)}),{active:f,selfRef:d,play(){c!==null&&(window.clearTimeout(c),f.value=!1,c=null),_e(()=>{var n;(n=d.value)===null||n===void 0||n.offsetHeight,f.value=!0,c=window.setTimeout(()=>{f.value=!1,c=null},1e3)})}}},render(){const{clsPrefix:e}=this;return m("div",{ref:"selfRef","aria-hidden":!0,class:[`${e}-base-wave`,this.active&&`${e}-base-wave--active`]})}}),{cubicBezierEaseInOut:w}=He;function Ze({duration:e=".2s",delay:d=".1s"}={}){return[v("&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to",{opacity:1}),v("&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from",`
 ...
 margin-left ${e} ${w},
 margin-right ${e} ${w};
 `)]}const eo=D&&"chrome"in window;D&&navigator.userAgent.includes("Firefox");const oo=D&&navigator.userAgent.includes("Safari")&&!eo;function S(e){return le(e,[255,255,255,.16])}function O(e){return le(e,[0,0,0,.12])}const ro=se("n-button-group"),to=v([j("button",`
 margin: 0;
 ...
 `,[x("active",{zIndex:1,animationName:"button-wave-spread, button-wave-opacity"})]),D&&"MozBoxSizing"in document.createElement("div").style?v("&::moz-focus-inner",{border:0}):null,u("border, state-border",`
 position: absolute;
 left: 0;
 top: 0;
 right: 0;
