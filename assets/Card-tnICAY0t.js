import{bO as X,b6 as Y,O as ee,z as a,v,_ as oe,y as i,x as d,Z as re,a9 as ne,B as S,e as te,C as ae,D as de,d as y,F as se,k as b,bP as ie,H as z,a0 as le}from"./index-Bd9XDiFr.js";import{g as ce}from"./Space-BMzkxCai.js";function k(e,...n){if(Array.isArray(e))e.forEach(c=>k(c,...n));else return e(...n)}function be(e){return Object.keys(e)}function l(e){return e.some(n=>X(n)?!(n.type===Y||n.type===ee&&!l(n.children)):!0)?e:null}function ue(e,n){return e&&l(e())||n()}function me(e,n,c){return e&&l(e(n))||c(n)}function h(e,n){const c=e&&l(e());return n(c||null)}function pe(e){return!(e&&l(e()))}function Ce(e){return e.replace(/#|\(|\)|,|\s|\./g,"_")}const ge=a([v("card",`
